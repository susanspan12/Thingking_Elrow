...
//****LED strip*******************************************************
const int THEME_HUE_BLUE = 0;
const int THEME_HUE_PURPLE = 230;
const int THEME_HUE_PINK = 190;
const int THEME_HUE_AQUA = 35;
const int THEME_HUE_YELLOW = 140;

const int chsv_orange = 150;
...
void default_animation_5() {
  ...
  while (millis() - default_timer < DEFAULT_TIME) {
    ...
    lightning(CHSV (THEME_HUE_BLUE, 200, 255), 20, 50, MEDIUM / 1.5);
  }
}
...
void default_animation_7() {
  ...
  while (millis() - default_timer < DEFAULT_TIME) {
    ...
    lightning(CHSV(THEME_HUE_PINK, 255, 255), 20, 50, MEDIUM / 1.5);
...
void animation_1() {
  ...
  allColor(CHSV (chsv_orange, 255, 255));
